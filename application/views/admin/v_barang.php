...
<head>
    ...
    <meta name="author" content="Tiga Putra Group">
   ...
   ?>
    ...
    <div class="container">
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $id;?></td>
                        <td><img src="<?php echo base_url(); ?>./uploads/<?php echo $gbr; ?>" width="90" height="90"></td>
                        <td><?php echo $nm;?></td>
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
           ...
           <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="gbr" value="gbr" class="file" type="file" placeholder="Gambar..." style="width:300px;" required>
                        </div>
                    </div>
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        <div class="modal-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="control-label col-xs-3" >Gambar</label>
                            <div class="col-xs-9">
                                <input name="gbr" class="form-control" type="file" value="<?php echo $gbr;?>" placeholder="Gambar..." style="width:335px;" required>
                            </div>
                        </div>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo date('Y');?> by Pustaka Umum</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
