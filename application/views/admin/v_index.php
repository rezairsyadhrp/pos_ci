...
<body>
<img src="<?php echo base_url().'assets/img/welcome.jpg'?>" alt="gambar" class="bg" />
    <!-- Navigation -->
   <?php 
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color:blue;">Selamat Datang
                    <small>di Kasir Pustaka Umum</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
